import { JSBI, Token } from '@AIHISwap/sdk'
...
export default function MigrateV1({ history }: RouteComponentProps) {
  ...
  const V1LiquidityTokens: Token[] = useMemo(() => {
    return Object.keys(V1Exchanges).map(
      exchangeAddress => new Token(chainId, exchangeAddress, 18, 'UNI-V1', 'AIHISwap V1')
    )
  }, [chainId, V1Exchanges])
    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        ...
        <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
          For each pool shown below, click migrate to remove your liquidity from AIHISwap V1 and deposit it into AIHISwap
          V2.
        </TYPE.body>
