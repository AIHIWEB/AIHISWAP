...
import { ChainId } from '@AIHISwap/sdk'
import { abi as IAIHISwapV2PairABI } from '@AIHISwap/v2-core/build/IAIHISwapV2Pair.json'
...
export function usePairContract(pairAddress?: string, withSignerIfPossible?: boolean): Contract | null {
  return useContract(pairAddress, IAIHISwapV2PairABI, withSignerIfPossible)
}
